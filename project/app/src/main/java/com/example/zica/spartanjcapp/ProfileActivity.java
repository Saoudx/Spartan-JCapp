...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StorageReference storageReference = firebaseStorage.getReference();//point to the root of the storage
        ...
        profileUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ProfileActivity.this, UpdateProfile.class));//when we click edit will got to update class
            }
        });
